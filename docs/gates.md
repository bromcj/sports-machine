...
|---|---|---|
| `walk_forward` | the model beats a **real** de-vigged market in every test season | `record()` |
| `paper_trading` | 50+ graded paper bets, mean CLV clear of zero by 3 SE, across 3+ start-time buckets | `record_paper()` |
...
| constant | value | why |
|---|---|---|
| `MIN_COVERAGE` | 0.75 | graded / settled. Below this, gate 2 fails: a CLV average over a quarter of the sample is not the sample. |
